...
def run():
    ...
    """
    inputs = {
        'motion': 'In response to AI-driven job displacement, governments should implement Universal Base Income (UBI) to ensure economic stability for the workforce.',
    }
